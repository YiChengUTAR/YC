<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Containers.aspx.vb" Inherits="ControlsDemo.Containers" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel ID="Panel1" runat="server" Visible="False">
                <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" Height="84px" Width="500px">
                    <WizardSteps>
